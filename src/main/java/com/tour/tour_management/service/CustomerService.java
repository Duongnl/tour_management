...
public class CustomerService {
    ...
    public CustomerDetailResponse createCustomer(CustomerRequest customerRequest) {
        ...
        historyService.createHistory("Create customer: " + customerSaved.getCustomer_name());
    ...
    public CustomerDetailResponse updateCustomer(String CUSTOMER_url, CustomerRequest customerRequest) {
        ...
        Customer customerOld=customerMapper.copy( customer );
        // check phone number
        ...
        historyService.createHistory(getCustomerChangedString(customerOld, customerSaved));
        return customerMapper.toCustomerDetailResponse(customerSaved);
    }

    private static @NotNull String getCustomerChangedString(Customer customer, Customer customerSaved) {
        StringBuilder customerChangedString = new StringBuilder("Update customer: ");
        ...
        for (Field field : fields) {
            try {
                ...
                Object value1 = field.get(customer);
                Object value2 = field.get(customerSaved);

                // So sánh giá trị, nếu khác nhau thì thêm vào chuỗi thay đổi
                if (!Objects.equals(value1, value2)) {
                    customerChangedString.append(" ")
        ...
        return customerChangedString.toString();
    }
    ...
    public CustomerDetailResponse changeStatus(String customer_url) {
        ...
        Customer customerSaved = customerRepository.save(customer);
        historyService.createHistory("Changed status customer: " + customerSaved.getCustomer_name() + " - " + customerSaved.getCustomer_id());
